...
mininput.oninput = function () {
  ...
  mininput.value < 10
    ? (clockmin.innerText = "0" + mininput.value + ":")
    : (clockmin.innerText = mininput.value + ":");
};

secinput.oninput = function () {
  secinput.value < 10
    ? (clocksec.innerText = "0" + secinput.value)
    : (clocksec.innerText = secinput.value);
};
...
var countdown = function () {
  ...
  var intervalId = setInterval(function () {
    ...
    if (pauseCheck !== 0) {
      ...
      pausedMin < 10
        ? (clockMin.innerText = "0" + pausedMin + ":")
        : pausedMin + ":";
      pausedSec < 10 ? (clocksec.innerText = "0" + pausedSec) : pausedSec;
    }
    if (pauseCheck === 0) {
      {
        sec = sec - 1;
      ...
      min < 10 ? (clockMin.innerText = "0" + min + ":") : min + ":";
      sec < 10 ? (clocksec.innerText = "0" + sec) : sec;
    }
